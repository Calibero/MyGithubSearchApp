...
/***/ function(module, exports, __webpack_require__) {
	...
	var github = __webpack_require__(227);
	...
	var Main = React.createClass({
	  ...
	  handleSearch: function handleSearch(username) {
	    var that = this;
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(Profile, { userData: this.state.userData, userRepos: this.state.userRepos })
	    );
	  }
	});
	...
	var Search = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'form',
	        { onSubmit: this.onFormSubmit, className: 'col-md-4 col-md-offset-4' },
	        React.createElement(
	          'div',
	          { className: 'col-md-8' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ReposList = __webpack_require__(225);
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'div',
	                { className: 'col-md-4' },
	                React.createElement('img', { src: userData.avatar_url, alt: userData.name, className: 'thumbnail', style: { width: "100%" } })
	              ),
	              React.createElement(
	                'div',
	                { className: 'col-md-8' },
	                ...
	                React.createElement(
	                  'a',
	                  { href: userData.html_url, className: 'btn btn-info', target: '_blank' },
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'div',
	                { className: 'col-md-12' },
	                React.createElement(ReposList, { userRepos: userRepos })
	              )
	            )
	          )
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Repo = __webpack_require__(226);

	var ReposList = React.createClass({
	  displayName: 'ReposList',

	  getRepoListItem: function getRepoListItem(repos) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CLIENT_ID = '5e4c2359b46d017b918c';
	var CLIENT_SECRET = 'eb77e69953b79fffdff801c5b123225ce241774e';
